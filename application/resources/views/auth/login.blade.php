...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="assets/plugins/images/master/logo.png">
    <title>Login</title>
    <!-- Bootstrap Core CSS -->
...
<style type ="text/css">
.login-register{background:url(assets/plugins/images/master/3.jpg ) center center/cover no-repeat!important;height:100%;position:fixed}
</style>
            ...
            <div class="white-box">
                <form class="form-horizontal form-material" id="loginform" action="{{ route('login') }}" method="POST" >
                 @csrf
                    ...
                    <a href="asdadw" class="text-center db"><img src="{{ asset('images/layouts/logo_holtikulture.png') }}" width="150px" height="150px" alt="Home" />

...
@if(Session::has('alert'))
    ...
    <script type="text/javascript">
        window.confirm("{{ Session::get('alert')}}.")
    </script>
        <script type='text/javascript'>
...
<style type ="text/css">
.login-registerr{background:url("{{ asset('images/layouts/bg.jpg') }}") center center/cover no-repeat!important;height:100%; width: 10px; position:fixed}
</style>
